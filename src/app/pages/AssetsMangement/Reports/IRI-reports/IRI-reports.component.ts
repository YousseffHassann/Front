...
@Component({
  selector: 'ngx-IRI-reports',
  templateUrl: './IRI-reports.component.html',
  styleUrls: ['./IRI-reports.component.scss']
})
export class MaintenanceReportsComponent implements OnInit {
  ...
  submitForm() {
    ...
    if (this.form.controls.SectionNo.value.length == 0) {
      ...
      this.aa = this.baseurl.ReportsHost + 'IRISamples.aspx?rname=IRISamples&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO + '&Lane=' + this.laneType + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
      this.sectionIRI = this.baseurl.ReportsHost + 'IRISections.aspx?rname=IRISections&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
      this.laneIRI = this.baseurl.ReportsHost + 'IRILanes.aspx?rname=IRILanes&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO + '&Lane=' + this.laneType + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
