...
@Component({
  selector: 'ngx-md-reports',
  templateUrl: './md-reports.component.html',
  styleUrls: ['./md-reports.component.scss']
})
export class MDReportsComponent implements OnInit  {
  ...
  sectionMD: string;
  laneMD: string;
  sectionMDSafeSrc: SafeResourceUrl;
...
Increase:any=0;
  ...
  downloadLaneMDReport(){
    const link = document.createElement('a');
    link.setAttribute('target', '_blank');
    link.setAttribute('href',   this.laneMD + '&type=x');
...
downloadSectionMDReport(){
  const link = document.createElement('a');
  link.setAttribute('target', '_blank');
  link.setAttribute('href', this.sectionMD+ '&type=x'  );
  link.setAttribute('download', `MD-report.pdf`);
  document.body.appendChild(link);
  link.click();
  link.remove();
...
Refresh() {
  ...
  submitForm() {
    ...
    if(this.form.controls.SectionNo.value.length == 0) {
      this.aa = this.baseurl.ReportsHost + 'MDSamples.aspx?rname=MDSamples&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=null&Lane=null&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
      this.sectionMD = this.baseurl.ReportsHost + 'MDSections.aspx?rname=MDSections&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=null&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
      this.laneMD = this.baseurl.ReportsHost + 'MDLanes.aspx?rname=MDLanes&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=null&Lane=null&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
    }
    else
    {this.aa = this.baseurl.ReportsHost + 'MDSamples.aspx?rname=MDSamples&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO + '&Lane=' + this.laneType + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
    this.sectionMD = this.baseurl.ReportsHost + 'MDSections.aspx?rname=MDSections&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO  + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
    this.laneMD = this.baseurl.ReportsHost + 'MDLanes.aspx?rname=MDLanes&module=pci&surveyNo=' + this.form.controls.SN.value[0].SURVEY_NO + '&SectionNo=' + this.form.controls.SectionNo.value[0].SECTION_NO + '&Lane=' + this.laneType + '&MainNo=' + this.form.controls.StreetId.value[0].MAIN_NO;
     }

   //his.aa = this.baseurl.ReportsHost +'StaticReports/IRIreport_NamaaFinalReport9-5-2023.pdf';
    console.log(this.aa);

    this.sectionMDSafeSrc = this.sanitizer.bypassSecurityTrustResourceUrl(this.sectionMD);
    this.laneMDSafeSrc = this.sanitizer.bypassSecurityTrustResourceUrl(this.laneMD);
    this.safeSrc = this.sanitizer.bypassSecurityTrustResourceUrl(this.aa);
